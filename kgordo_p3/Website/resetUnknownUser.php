		...
		<img class="splashImg" style="z-index:-1" src="images/Rectangle 1.png">
			<div id="Login">
					...
					<form name="ResetUser"
						...
						<p id="FieldSpec"><input class="fieldSize" type="text" id="personName" name="userCheck" placeholder="Enter Username" size="50%"/> </p>
						<p id="FieldSpec"><input class="fieldSize"  type="password" id="pwd" name="Opwd" placeholder="Enter Current Password"  minlength="8" size="50%"/> </p>
						<p id="FieldSpec"><input class="fieldSize"  type="password" id="pwd" name="Npwd" placeholder="Enter New Password"  minlength="8" size="50%"/> </p>
						<p id="FieldSpec"><input class="fieldSize"  type="password" id="pwd" name="Verifypwd" placeholder="Re-Enter New Password"  minlength="8" size="50%"/> </p>

						<br>	<br>	<br><br><br><br><br><br>
						<a href="">Forgot Username</a><br><br>
						<a href="">Reset Password</a>
						<p ><input class="buttonForm" style="margin-top:-18%" type="submit" name="ResetUnknownPass" value="Submit" /></p>
					</form>
