		...
		<img class="splashImg" style="z-index:-1" src="images/Rectangle 1.png">
			<div id="Login">
					...
					<form name="ResetUser"
						...
						<p id="FieldSpec"><input class="fieldSize" type="text" id="personName" name="emailCheck" placeholder="Enter Email" size="50%"/> </p>
						...
						<p ><input class="buttonForm" style="margin-top:-18%" type="submit" name="ResetPass" value="Submit" /></p>
					</form>
